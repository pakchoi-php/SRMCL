...
from Model.VIT_SRMCL import Model
...
model_dir ="./best_model/casmeII_SRMCL"
...
if __name__=='__main__':
    ...
    for leave_out_sub in all_sub_list:
        ...
        model_path = os.path.join(model_dir, f'model_Total_sub{leave_out_sub}.pt')
        ...
        with torch.no_grad():
            ...
            for i, (image_one, image_two, label) in enumerate(test_loader):
                ...
                y_pred, loss1 = net.forward(image_one, mask_ratio=0,labels=y)
                # print(feature.shape)
